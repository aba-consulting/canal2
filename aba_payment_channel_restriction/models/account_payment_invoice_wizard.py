    ...
    def _compute_available_journal_ids(self):
        ...
        for rec in self:
            ...
            if invoice_journals:
                ...
                if es_canal_2:
                    # Si el diario de la factura es canal 2, mostramos solo diarios marcados como canal 2
                    journal_domain.append(("es_canal_2", "=", True))
                else:
                    # Si el diario de la factura no es canal 2, mostramos solo diarios que no sean canal 2
